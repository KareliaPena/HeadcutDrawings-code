...
parser.add_argument('--content', type=str, default="./Data/sample/Content/Image",
                    help="path to the folder of content images")
parser.add_argument('--max_dim', type=int, default=900,
                    help="Maximum dimension of the grid resolution")
